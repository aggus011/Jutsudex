...
<head>
    ...
    <link rel="stylesheet" href="./Recursos/css/busqueda.css">
</head>
<?php
...
<main>
    <div class="conteiner">
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                $sqlbusqueda = "SELECT nombre FROM jutsu where nombre LIKE '%".$_GET['busqueda']."%'";
                $resbusqueda = $conexion->query($sqlbusqueda);
                $query = "Select nro, nombre, tipo, img_url FROM jutsu where nombre LIKE '%".$_GET['busqueda']."%'";
                ...
                if($resbusqueda->num_rows == 0){
                    ...
                    $res = $conexion->query($query);
                    echo "<p id='error'> No encontre el jutsu que estas queriendo buscar :( </p>";
                    while($row = mysqli_fetch_array($res)){
                        echo "<tr>";
    ...
    if($usuario != ""){
        ...
        <button type='submit'>¡Agrega un jutsu! </button>
    </form>";
    } else{
